...
def generate_pdf_report(filepath, data):
    ...
    for key, value in data.items():
        ...
        for line in lines:
            c.drawString(70, y, line[:100])  # truncate line if too long
            y -= 15
            if y < 50:
                c.showPage()
                y = height - 50
...
if __name__ == "__main__":
    print("📄 Analyzing RFP for biased clauses using Hybrid (RAG + ReAct)...\n")
    ...
    for clause in similar_clauses:
        ...
        if isinstance(agent_step, AgentAction):
            ...
            final_results.append({"clause": clause, **observation})
    ...
    for result in final_results:
        ...
        print(f"Reason: {result.get('bias_reason', 'N/A')}")
